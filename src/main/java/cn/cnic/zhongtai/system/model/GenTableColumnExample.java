...
public class GenTableColumnExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andIsIncrementIn(List<String> values) {
            addCriterion("is_increment in", values, "isIncrement");
            return (Criteria) this;
        }

        public Criteria andIsIncrementNotIn(List<String> values) {
        ...
        public Criteria andHtmlTypeIn(List<String> values) {
            addCriterion("html_type in", values, "htmlType");
            return (Criteria) this;
        }

        public Criteria andHtmlTypeNotIn(List<String> values) {
